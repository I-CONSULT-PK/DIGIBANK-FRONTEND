...
export const ROUTES: RouteInfo[] = [
  // { path: '/maiden', title: 'Home', icon: 'home', class: '' },
  {
    path: "/Admin/maiden",
    title: "Dashboard",
    icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/55831f7909cc1213c774fa6bbe9444e4bd7c3b5bdb8f0291c03d5b704ac2db4c?",
    class: "",
  },
  {
    path: "/Admin/Benificiary",
    title: "Add Benificiary ",
    icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/efd9de894b80c8cf24c31ef597db9a75e978543f6e37ba6562ca65cc4bec1520?",
    class: "",
  },
  {
    path: "/Admin/Accounts",
    title: "Accounts",
    icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/ce8af22fe078839128765c774cf001f56d2138998a6759ace921a094cc2c0b19?",
    class: "",
  },
  // { path: '/BankStatement', title: 'Bank Statement', icon: 'receipt_long', class: '' },
  {
    path: "/Admin/Login",
    title: "Logout ",
    icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/2a197809347bfb9e7280349b9933af1f13033b08d965df9ffde26a93a4ce3b9b?",
    class: "",
  },
